...
const steps = [
  { id: 1, label: "Client Profile", path: "/sales/onboardingProcess" },
  ...
  { id: 6, label: "E-Sign", path: "/sales/onboarding/esign" },
];
    ...
    <div className="flex gap-4 mb-10 mt-4">
      ...
      {steps.map((step, index) => (
        <Link
          key={step.id}
          to={step.path}
          className={`relative px-8 py-3 text-sm font-medium rounded-l-lg 
